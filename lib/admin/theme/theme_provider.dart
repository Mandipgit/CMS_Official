...
class ThemeProvider with ChangeNotifier {
  ...
  static final _lightTheme = ThemeData(
    ...
    switchTheme: SwitchThemeData(
      thumbColor: WidgetStateProperty.all(Color(0xFF1E88E5)),
      trackColor: WidgetStateProperty.all(Color(0xFF1E88E5).withOpacity(0.5)),
    ),
    checkboxTheme: CheckboxThemeData(
      fillColor: WidgetStateProperty.all(Color(0xFF1E88E5)),
    ),
  ...
  static final _darkTheme = ThemeData(
    ...
    dataTableTheme: DataTableThemeData(
      headingRowColor: WidgetStateProperty.all(Color(0xFF1E1E1E)),
      dataRowColor: WidgetStateProperty.all(Color(0xFF151515)),
